...
const Header = () => {
  ...
  return (
    ...
    <div
      ...
      aria-labelledby="navbarDropdown"
    >
      <h6 className="dropdown-header mb-3 text-primary">Popular Categories</h6>
      <div className="row">
        <div className="col-6">
        ...
        <div className="col-6">
          ...
          <Link className="dropdown-item" to="/meatandeggs">
            <FaDrumstickBite className="icon" /> Meat & Eggs
          </Link>
  ...
  <div className="dropdown-menu sm-menu p-3" aria-labelledby="navbarDropdown">
    {/* Order Settings */}
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content p-4">
            ...
            <div className="modal-footer border-0 justify-content-center" data-bs-dismiss="modal">
